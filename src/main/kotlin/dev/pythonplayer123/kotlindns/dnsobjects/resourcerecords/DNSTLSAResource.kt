...
class DNSTLSAResource(
...
) : DNSResourceRecord(name, DNSRRType.TLSA, dnsClass, ttl) {
    ...
    companion object : DNSResourceCompanionObject {
        override val value: DNSRRType = DNSRRType.TLSA
        ...
        override fun parse(
            ...
            return Pair(DNSTLSAResource(name, dnsClass, ttl, certUsage, selector, matchingType, certAssocData), i)
        }
    }
}