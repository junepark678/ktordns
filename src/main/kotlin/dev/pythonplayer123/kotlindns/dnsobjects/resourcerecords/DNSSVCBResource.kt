...
class DNSSVCBResource(
...
) : DNSResourceRecord(name, DNSRRType.SVCB, dnsClass, ttl) {
    ...
    companion object : DNSResourceCompanionObject {
        override val value: DNSRRType = DNSRRType.SVCB
        ...
        override fun parse(
            ...
            return Pair(DNSSVCBResource(name, dnsClass, ttl, priority, targetName, params), i)
        }
    }
}